...
import com.example.appdatdouong_refreshrush.Dao.NhanVienDao;
...
public class ManHinh_DangNhap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ManHinh_DangNhap.this, Register.class);
    ...
    private void login() {
        ...
        if (selectedPosition == 0) { // Check if "Người dùng" is selected
            ...
            if (result == 1) {
                ...
                Intent intent = new Intent(ManHinh_DangNhap.this, Menu_navigation.class);
