...
public class GioHangAdapter extends BaseAdapter {
    ...
    public GioHangAdapter(Context context, List<GioHang> gioHangList, String userType, String maKh) {
        ...
        this.doUongDao = new DoUongDAO(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DoUong doUong = doUongDao.getSanPhamByMaSp(String.valueOf(gioHang.getIdDoUong()));
        ...
        if (doUong != null) {
            viewHolder.tvTenSp.setText("Tên sản phẩm : " + doUong.getTenDoUong());
            viewHolder.tvThanhTien.setText("Thành tiền : " + doUong.getGiaDoUong() * gioHang.getSoLuong());
        ...
        btnDatHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!donHangDao.isMaGioExists(String.valueOf(gioHang.getMaGio()))) {
                    ...
                    DoUong doUong1 = doUongDao.getSanPhamByMaSp(String.valueOf(gioHang.getIdDoUong()));
                    if (doUong1 != null) {
